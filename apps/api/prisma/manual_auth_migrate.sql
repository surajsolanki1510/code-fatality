...
CREATE UNIQUE INDEX IF NOT EXISTS "QuestCompletion_userId_questId_key"
  ON "QuestCompletion"("userId", "questId");
...
INSERT INTO "QuestCompletion" (id, "userId", "questId", "xpEarned")
...
ALTER TABLE "Progress" DROP COLUMN IF EXISTS "completedQuestIds";
